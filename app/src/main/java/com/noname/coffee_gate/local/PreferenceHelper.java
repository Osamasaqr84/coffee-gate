package com.noname.coffee_gate.local;
...
public class PreferenceHelper {
	...
	private static String CurrentLAng = "CurrentLAng";
	...
	public static String getCurrentLang() {
		return app_prefs.getString(CurrentLAng,"en");
	}
	...
	public static void setCurrentLang(String lang) {
		Editor edit = app_prefs.edit();
		edit.putString(CurrentLAng, lang);
		edit.apply();
	}
